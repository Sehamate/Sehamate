...
class DoctorChatViewBody extends StatefulWidget {
  const DoctorChatViewBody({super.key});

  @override
  State<DoctorChatViewBody> createState() => _DoctorChatViewBodyState();
}

class _DoctorChatViewBodyState extends State<DoctorChatViewBody> {
  DoctorChatCubit get cubit => BlocProvider.of(context);
  @override
